         ...
         <?php
                ...
                if($count>0)
                {
                     while($row=mysqli_fetch_assoc($res))
                   {
                        ...
                        <a href="<?php echo 'http://localhost/restorent/w/category-foods.php?category_id='?><?php echo $id ?>">
                        ...
                        echo "<div class='error'>Image noi avilable</div>";
                         ...
                         ?>
                           ...
                           <img src="http://localhost\restorent\w\images\category\<?php echo $image_name; ?>" alt="Pizzza" class="img-responsive img-curve">
    ...
    <section class="food-menu">
        ...
        <p class="text-center">
            <a href="<?php echo 'http://localhost/restorent/w/foods.php' ?>">See All Foods</a>
        </p>
    </section>
